...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AdminChatbotController' => 'getAdminChatbotControllerService',
            'App\\Controller\\AdminController' => 'getAdminControllerService',
            'App\\Controller\\AdminPublicationController' => 'getAdminPublicationControllerService',
            'App\\Controller\\AdminPublicationStatisticsController' => 'getAdminPublicationStatisticsControllerService',
            ...
            'App\\Controller\\AdminWhatsAppSessionController' => 'getAdminWhatsAppSessionControllerService',
            'App\\Controller\\Admin\\AdminReservationController' => 'getAdminReservationController2Service',
            'App\\Controller\\Admin\\AdminTransportReservationController' => 'getAdminTransportReservationControllerService',
            'App\\Controller\\Admin\\MapPickerController' => 'getMapPickerControllerService',
            ...
            'App\\Controller\\CategorieHebergementController' => 'getCategorieHebergementControllerService',
            ...
            'App\\Controller\\FraudDetectionController' => 'getFraudDetectionControllerService',
            'App\\Controller\\FrontOfficeController' => 'getFrontOfficeControllerService',
            'App\\Controller\\HebergementAiController' => 'getHebergementAiControllerService',
            'App\\Controller\\HebergementApiController' => 'getHebergementApiControllerService',
            'App\\Controller\\HebergementController' => 'getHebergementControllerService',
            'App\\Controller\\HebergementDetailController' => 'getHebergementDetailControllerService',
            'App\\Controller\\HebergementQpAiController' => 'getHebergementQpAiControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\LoisirController' => 'getLoisirControllerService',
            'App\\Controller\\MapController' => 'getMapControllerService',
            'App\\Controller\\MesReservationsController' => 'getMesReservationsControllerService',
            ...
            'App\\Controller\\PasswordGeneratorController' => 'getPasswordGeneratorControllerService',
            ...
            'App\\Controller\\SmartJourneyController' => 'getSmartJourneyControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ltw9EPaoHo', 0, (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'share'.\DIRECTORY_SEPARATOR.'dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lKBrb1UbN7', 0, (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'share'.\DIRECTORY_SEPARATOR.'dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mXo388ZlUv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('98ma6SO+FY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventListener\\NotificationListener')] fn () => ($container->privates['App\\EventListener\\NotificationListener'] ?? self::getNotificationListenerService($container)), 'onKernelController'], 0);
    ...
    /**
     * Gets the private '.service_locator.MVe1fEg' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_MVe1fEgService($container)
    {
        ...
        if (isset($container->privates['.service_locator.MVe1fEg'])) {
            return $container->privates['.service_locator.MVe1fEg'];
        }

        return $container->privates['.service_locator.MVe1fEg'] = $instance;
    }
    ...
    protected static function getDoctrineDoctorDataCollectorService($container)
    {
        ...
        $instance = new \AhmedBhs\DoctrineDoctor\Collector\DoctrineDoctorDataCollector(new RewindableGenerator(function () use ($container) {
            ...
            yield 16 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\ColumnTypeAnalyzer'] ?? $container->load('getColumnTypeAnalyzerService'));
            yield 17 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\DecimalPrecisionAnalyzer'] ?? $container->load('getDecimalPrecisionAnalyzerService'));
            yield 18 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\DivisionByZeroAnalyzer'] ?? $container->load('getDivisionByZeroAnalyzerService'));
            yield 19 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\EmbeddableMutabilityAnalyzer'] ?? $container->load('getEmbeddableMutabilityAnalyzerService'));
            yield 20 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\EmbeddableWithoutValueObjectAnalyzer'] ?? $container->load('getEmbeddableWithoutValueObjectAnalyzerService'));
            yield 21 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\EntityManagerInEntityAnalyzer'] ?? $container->load('getEntityManagerInEntityAnalyzerService'));
            yield 22 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\EntityStateConsistencyAnalyzer'] ?? $container->load('getEntityStateConsistencyAnalyzerService'));
            yield 23 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\FinalEntityAnalyzer'] ?? $container->load('getFinalEntityAnalyzerService'));
            yield 24 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\FloatForMoneyAnalyzer'] ?? $container->load('getFloatForMoneyAnalyzerService'));
            yield 25 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\FloatInMoneyEmbeddableAnalyzer'] ?? $container->load('getFloatInMoneyEmbeddableAnalyzerService'));
            yield 26 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\ForeignKeyMappingAnalyzer'] ?? $container->load('getForeignKeyMappingAnalyzerService'));
            yield 27 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\JoinTypeConsistencyAnalyzer'] ?? $container->load('getJoinTypeConsistencyAnalyzerService'));
            yield 28 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\MissingEmbeddableOpportunityAnalyzer'] ?? $container->load('getMissingEmbeddableOpportunityAnalyzerService'));
            yield 29 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\MissingOrphanRemovalOnCompositionAnalyzer'] ?? $container->load('getMissingOrphanRemovalOnCompositionAnalyzerService'));
            yield 30 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\NullComparisonAnalyzer'] ?? $container->load('getNullComparisonAnalyzerService'));
            yield 31 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\OnDeleteCascadeMismatchAnalyzer'] ?? $container->load('getOnDeleteCascadeMismatchAnalyzerService'));
            yield 32 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\OrphanRemovalWithoutCascadeRemoveAnalyzer'] ?? $container->load('getOrphanRemovalWithoutCascadeRemoveAnalyzerService'));
            yield 33 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\PartialObjectAnalyzer'] ??= new \AhmedBhs\DoctrineDoctor\Analyzer\Integrity\PartialObjectAnalyzer(5));
            yield 34 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\PrimaryKeyStrategyAnalyzer'] ?? $container->load('getPrimaryKeyStrategyAnalyzerService'));
            yield 35 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\PropertyTypeMismatchAnalyzer'] ?? $container->load('getPropertyTypeMismatchAnalyzerService'));
            yield 36 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\QueryBuilderBestPracticesAnalyzer'] ?? $container->load('getQueryBuilderBestPracticesAnalyzerService'));
            yield 37 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\SoftDeleteableTraitAnalyzer'] ?? $container->load('getSoftDeleteableTraitAnalyzerService'));
            yield 38 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\TimestampableTraitAnalyzer'] ?? $container->load('getTimestampableTraitAnalyzerService'));
            yield 39 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\TransactionBoundaryAnalyzer'] ?? $container->load('getTransactionBoundaryAnalyzerService'));
            yield 40 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Integrity\\TypeHintMismatchAnalyzer'] ?? $container->load('getTypeHintMismatchAnalyzerService'));
            yield 41 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\BulkOperationAnalyzer'] ?? $container->load('getBulkOperationAnalyzerService'));
            yield 42 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\DTOHydrationAnalyzer'] ?? $container->load('getDTOHydrationAnalyzerService'));
            yield 43 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\EagerLoadingAnalyzer'] ?? $container->load('getEagerLoadingAnalyzerService'));
            yield 44 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\EntityManagerClearAnalyzer'] ?? $container->load('getEntityManagerClearAnalyzerService'));
            yield 45 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\FindAllAnalyzer'] ?? $container->load('getFindAllAnalyzerService'));
            yield 46 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\FlushInLoopAnalyzer'] ?? $container->load('getFlushInLoopAnalyzerService'));
            yield 47 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\FlushInLoopAnalyzerModern'] ?? $container->load('getFlushInLoopAnalyzerModernService'));
            yield 48 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\GetReferenceAnalyzer'] ?? $container->load('getGetReferenceAnalyzerService'));
            yield 49 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\HydrationAnalyzer'] ?? $container->load('getHydrationAnalyzerService'));
            yield 50 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\IneffectiveLikeAnalyzer'] ?? $container->load('getIneffectiveLikeAnalyzerService'));
            yield 51 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\JoinOptimizationAnalyzer'] ?? $container->load('getJoinOptimizationAnalyzerService'));
            yield 52 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\LazyLoadingAnalyzer'] ?? $container->load('getLazyLoadingAnalyzerService'));
            yield 53 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\MissingIndexAnalyzer'] ?? $container->load('getMissingIndexAnalyzerService'));
            yield 54 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\NPlusOneAnalyzer'] ?? $container->load('getNPlusOneAnalyzerService'));
            yield 55 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\OrderByWithoutLimitAnalyzer'] ?? $container->load('getOrderByWithoutLimitAnalyzerService'));
            yield 56 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\QueryCachingOpportunityAnalyzer'] ?? $container->load('getQueryCachingOpportunityAnalyzerService'));
            yield 57 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\SetMaxResultsWithCollectionJoinAnalyzer'] ?? $container->load('getSetMaxResultsWithCollectionJoinAnalyzerService'));
            yield 58 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\SlowQueryAnalyzer'] ?? $container->load('getSlowQueryAnalyzerService'));
            yield 59 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Performance\\YearFunctionOptimizationAnalyzer'] ?? $container->load('getYearFunctionOptimizationAnalyzerService'));
            yield 60 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Security\\DQLInjectionAnalyzer'] ?? $container->load('getDQLInjectionAnalyzerService'));
            yield 61 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Security\\InsecureRandomAnalyzer'] ?? $container->load('getInsecureRandomAnalyzerService'));
            yield 62 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Security\\SQLInjectionInRawQueriesAnalyzer'] ?? $container->load('getSQLInjectionInRawQueriesAnalyzerService'));
            yield 63 => ($container->privates['AhmedBhs\\DoctrineDoctor\\Analyzer\\Security\\SensitiveDataExposureAnalyzer'] ?? $container->load('getSensitiveDataExposureAnalyzerService'));
        }, 64), ($container->privates['data_collector.doctrine'] ?? self::getDataCollector_DoctrineService($container)), $a, ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)), false, new \AhmedBhs\DoctrineDoctor\Collector\DataCollectorHelpers(new \AhmedBhs\DoctrineDoctor\Collector\Helper\DatabaseInfoCollector($b, $c), new \AhmedBhs\DoctrineDoctor\Collector\Helper\IssueReconstructor(($container->privates['AhmedBhs\\DoctrineDoctor\\Template\\Renderer\\TemplateRendererInterface'] ?? self::getTemplateRendererInterfaceService($container))), new \AhmedBhs\DoctrineDoctor\Collector\Helper\QueryStatsCalculator(), new \AhmedBhs\DoctrineDoctor\Collector\Helper\DataCollectorLogger($b, $c), new \AhmedBhs\DoctrineDoctor\Service\IssueDeduplicator()), $container->parameters['doctrine_doctor.analysis.exclude_paths']);
    ...
    protected static function getNotificationListenerService($container)
    {
        ...
        $instance = new \App\EventListener\NotificationListener(($container->privates['App\\Repository\\NotificationRepository'] ?? self::getNotificationRepositoryService($container)), $a, $b);

        if (isset($container->privates['App\\EventListener\\NotificationListener'])) {
            return $container->privates['App\\EventListener\\NotificationListener'];
        }

        return $container->privates['App\\EventListener\\NotificationListener'] = $instance;
    }
     ...
     */
    protected static function getHebergementRepositoryService($container)
    {
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LHMgv1MqYB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('d6DaBWQpFw', 0, (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'share'.\DIRECTORY_SEPARATOR.'dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LS2CzdPjWy', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QpuLaUv0yk', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r8a4yy0Nyd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Su2s6NdQsv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AeroportRepository' => ['privates', 'App\\Repository\\AeroportRepository', 'getAeroportRepositoryService', true],
            'App\\Repository\\CategorieHebergementRepository' => ['privates', 'App\\Repository\\CategorieHebergementRepository', 'getCategorieHebergementRepositoryService', true],
            ...
            'App\\Repository\\EmailVerificationRepository' => ['privates', 'App\\Repository\\EmailVerificationRepository', 'getEmailVerificationRepositoryService', true],
            ...
            'App\\Repository\\QuizSessionRepository' => ['privates', 'App\\Repository\\QuizSessionRepository', 'getQuizSessionRepositoryService', true],
            ...
            'App\\Repository\\ReclamationWhatsAppSessionRepository' => ['privates', 'App\\Repository\\ReclamationWhatsAppSessionRepository', 'getReclamationWhatsAppSessionRepositoryService', true],
            'App\\Repository\\ReponseReclamationRepository' => ['privates', 'App\\Repository\\ReponseReclamationRepository', 'getReponseReclamationRepositoryService', true],
            ...
            'App\\Repository\\WheelSpinRepository' => ['privates', 'App\\Repository\\WheelSpinRepository', 'getWheelSpinRepositoryService', true],
        ], [
            'App\\Repository\\AeroportRepository' => '?',
            'App\\Repository\\CategorieHebergementRepository' => '?',
            'App\\Repository\\CategorieRepository' => '?',
            'App\\Repository\\CommentaireRepository' => '?',
            'App\\Repository\\EmailVerificationRepository' => '?',
    ...
    {
        $a = ($container->privates['.service_locator.MVe1fEg'] ?? self::get_ServiceLocator_MVe1fEgService($container));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \App\Twig\AppExtension(($container->privates['App\\Repository\\HebergementRepository'] ?? self::getHebergementRepositoryService($container))));
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.base_url' => $container->getEnv('APP_URL'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'KnpSnappyBundle' => [
                    'path' => 'C:/Users/ibrnx/Downloads/projet final symf+java/integfinal/integfinal/vendor/knplabs/knp-snappy-bundle/src',
            ...
            'doctrine_doctor.analyzers.missing_index.slow_query_threshold' => 1,
            'doctrine_doctor.analyzers.missing_index.min_rows_scanned' => 5,
