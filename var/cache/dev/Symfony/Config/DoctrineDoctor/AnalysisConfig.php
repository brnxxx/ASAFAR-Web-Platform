...
class AnalysisConfig 
{
    ...
    {
        if (array_key_exists('exclude_third_party_entities', $config)) {
            $this->_usedProperties['excludeThirdPartyEntities'] = true;
            $this->excludeThirdPartyEntities = $config['exclude_third_party_entities'];
            unset($config['exclude_third_party_entities']);
        }
